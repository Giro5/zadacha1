...
#n = int(open("data.txt", "r").readlines()[0].strip())
#t = int(open("data.txt", "r").readlines()[1].strip())
#a = [int(open("data.txt", "r").readlines()[2 + i].split()[0]) for i in range(n)]
#b = [int(open("data.txt", "r").readlines()[2 + i].split()[1]) for i in range(n)]
